...
import paramtools
import behresp
from taxcalc.enginetax.policy import Policy
from taxcalc.enginetax.records import Records
from taxcalc.enginetax.consumption import Consumption
from taxcalc.enginetax.growdiff import GrowDiff
from taxcalc.enginetax.growfactors import GrowFactors
from taxcalc.enginetax.calculator import Calculator
from taxcalc.enginetax.utils import (
    json_to_dict, delete_file, write_graph_file,
...
class TaxCalcIO():
    ...
    def output_filepath(self):
        ...
        """
        # output files are written to the top-level taxcalc package
        # directory, which is the parent of this engine subpackage
